...
import classes from    '../styles/request-a-callback.module.css';
import { useRouter } from "next/router";
import React, { useEffect, useState, useCallback } from "react";

export default function RequestACallBack({postData}) {
    const data = postData;
    ...
    function savecallback() {
      let data = { name, mobile, captcha_cp, Uniqid };
  ...
  return (
    ...
    <Image src="/images/testimonials-banner.jpg" className="img-fluid" alt="Book An Appointment" layout="responsive" width={1366} height={545} />
      ...
      <section
        className="AboutBanner ServicePageBanner"
        style={{ paddingTop: "6rem", backgroundColor: "#e5eaf0" }}
      >
        {/* <CallBackForm /> */}
        <section className="sectionSpace z-class ptb sctnAppointmentBox">
          <div className="container">
            <div className="SctnHdng text-center my-3">Request A Callback</div>
            <Form
              noValidate
              method="post"
              validated={validated}
            ...
            >
              <Row className="justify-content-start align-items-start">
                <Form.Group
                  className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 input1"
                  controlId="name_cb"
                >
                  <Form.Control
                    required
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                  <div className="align-items-start row pb-2">
                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-6 d-flex cap-p form-input">
                      <Image
                    ...
                    <div className="col-lg-8 col-md-6 col-sm-6 col-xs-6 cap-p form-input">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 d-grid">
                  <Button
...
RequestACallBack.getLayout = function getLayout(page) {
  return (
    <Layout>
      <Header />
      {page}
...
export async function getServerSideProps(){
  const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/seo-tag/`+'request-a-callback',
      {
        method: 'GET'
      }
    );
