    ...
    return (
      <>
            ...
            <div className="AboutBannerTxt">
              <ul>
                ...
                <li>
                  ...
                  Association of Plastic Surgeons of India for “An objective
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-xl-10 col-lg-10 col-md-12 col-sm-12">
                <p className="AboutHsptlTxt1">
                  Dr. Mrinalini Sharma, one of the best female plastic surgeons
                  in Delhi, has completed her MBBS, MS and MCh from some of the
                  ...
                  Gurgaon as a consultant plastic surgeon. The skilled <strong>female cosmetic surgeon in Delhi</strong> has a motive to provide affordable  as well as effective plastic & cosmetic surgery treatments which can be availed by everyone.
                </p>
                ...
                <p className="AboutHsptlTxt1">
                  ...
                  Apart from these, women put their complete faith in Dr. Mrinalini Sharma, the <strong>best plastic surgeon in Delhi</strong>, when it comes to facelift and mommy makeover.
                </p>
        ...
        <section className={`sectionSpace ${styles.careerSctn}`}>
          <div className="container">
            <div className={`${styles.SctnHdng} text-center`}>
...
export async function getServerSideProps(){
  const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/seo-tag/`+'about-doctor',
      {
        method: 'GET'
      }
    );
