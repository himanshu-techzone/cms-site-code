            ...
            <div class="card-body">
                <div class="page-title pagetitle">
                    ...
                    <ul class="breadcrumb side">
                        ...
                        <li class="active">Add Result Service</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="service_cat" id="servicecategory" onchange="ResultCategory()">
                                ...
                                <option value="@if(isset($firstcategorylist->res_ser_id)){{$firstcategorylist->res_ser_id}}@endif" @if(isset($view->res_ser_id))@if($firstcategorylist->res_ser_id == $secondsec['firstser_id']) selected @endif @endif>{{$firstcategorylist->name}}</option>
                                @endforeach
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            @if(isset($view->image))
                            @if($view->image!='')
                            <img src="{{url('/'.session('useradmin')['site_url'].'backend/service_result/service/'.$view->image)}}" style="width: 85px;height: 85px;"><br>
                            @else
                        ...
                        @if(isset($view->banner_image))
                            ...
                            <img src="{{url('/'.session('useradmin')['site_url'].'backend/service_result/service_banner/'.$view->banner_image)}}" style="width: 85px;height: 85px;"><br>
                            @else
                            <img src="{{url('/images/no_image.jpg')}}" style="width:85px;height:85px;">
                            @endif
                            @else
                        ...
                        <div class="col-sm-12 marginT30">
                            ...
                            <a class="btn btn-default icon-btn" href="{{url('/admin/result-service')}}">
