...
<section id="main-content">
  ...
  <div class="card cardsec">
        ...
        <h1>Edit Second Video Category</h1>
        ...
        <li><a href="{{url('/admin/second-video-category')}}">Second Video Category List</a></li>
          <li class="active">Edit Second Video Category</li>
        </ul>
      </div>   
      </div>  
      </div> 
            ...
            <input type="hidden" name="category_type" value="secondcategory">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="parent_id">
                                ...
                                <option value="{{$firstcategorylist->vid_ser_id}}" @if(isset($edit->vid_ser_id))@if($firstcategorylist->vid_ser_id == $edit->parent_id) selected @endif @endif>{{$firstcategorylist->name}}</option>
                                @endforeach
                            </select>
                        </div>
				...
				<div class="col-sm-12 marginT30">
					...
					<a class="btn btn-default icon-btn" href="{{url('/admin/second-video-category')}}" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
				</div>
