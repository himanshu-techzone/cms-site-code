...
<div class="container">
  <div class="row">
    <div class="col s10 m6 l6">
      <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Doctor Certificate Image</span></h5>
      <ol class="breadcrumbs mb-0">
        ...
        <li class="breadcrumb-item active">Add Doctor Certificate Image</li>
      </ol>
    </div>
  </div>
</div>
...
<div class="card">
  ...
  <a class="waves-effect waves-light btn mr-1" href="{{url('/admin/doctor-certificate')}}">Back</a>
  </div>
</div>
</div>
        ...
        <form action="{{URL::to('/admin/create_doctor_certificate')}}" id="myForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            ...
            <div class="form-group col-md-4 col s4">
                            ...
                            <select class="form-control" name="certificate_show_type" required>
                                ...
                                <option value="inside" @if(isset($view->certificate_show_type))@if($view->certificate_show_type=='inside') selected @endif @else selected @endif>Inside</option>
                                <option value="outside" @if(isset($view->certificate_show_type))@if($view->certificate_show_type=='outside') selected @endif @endif>Outside</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4  col s4">
                            ...
                            <select class="form-control" name="doctor_id" required>
                                ...
                                <option value="{{ $doctorlistsec->doc_id }}" @if(isset($view->doctor_id))@if($view->doctor_id==$doctorlistsec->doc_id) selected @endif @endif>{{$doctorlistsec->name}}</option>
                                @endforeach
                            </select>
                        </div>
                <div class="form-group  col-md-4  col s4">
