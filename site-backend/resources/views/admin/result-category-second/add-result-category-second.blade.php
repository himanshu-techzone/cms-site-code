        ...
        <div class="card cardsec">
            <div class="card-body">
                <div class="page-title pagetitle">
                    <h1>Add Second Result Category</h1>
                    <ul class="breadcrumb side">
                        ...
                        <li class="active">Add Second Result Category</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="parent_id">
                                ...
                                <option value="{{$firstcategorylist->res_ser_id}}" @if(isset($view->res_ser_id))@if($firstcategorylist->res_ser_id == $view->parent_id) selected @endif @endif>{{$firstcategorylist->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="col-sm-12 marginT30">
                            ...
                            <a class="btn btn-default icon-btn" href="{{url('/admin/second-result-category')}}">
