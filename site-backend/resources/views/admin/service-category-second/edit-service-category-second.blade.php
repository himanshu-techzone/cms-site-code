...
<section id="main-content">
  ...
  <div class="card cardsec">
        ...
        <li><a href="{{url('/admin/second-category')}}">Second Category List</a></li>
          <li class="active">Edit Second Category</li>
        </ul>
      </div>   
      </div>  
      </div> 
            ...
            <input type="hidden" name="category_type" value="secondcategory">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="parent_id">
                                ...
                                <option value="{{$firstcategorylist->ser_id}}" @if(isset($edit->ser_id))@if($firstcategorylist->ser_id == $edit->parent_id) selected @endif @endif>{{$firstcategorylist->service_name}}</option>
                                @endforeach
                            </select>
                        </div>
               ...
               <div class="form-group col-sm-12">
				...
				<div class="col-sm-12 marginT30">
					...
					<a class="btn btn-default icon-btn" href="{{url('/admin/second-category')}}" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
				</div>
