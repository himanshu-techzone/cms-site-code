            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            @if($edit->image2!='')
                            <img src="{{url('/'.session('useradmin')['site_url'].'backend/doctor/'.$edit->image2)}}" style="width: 85px;height: 85px;"><br>
    ...
    function removesecrvice(rand, secid) {
        ...
        if (confirm("Do you really want to delete record?") == true) {
            $.ajax({
                ...
                success: function(result) {
                    // alert(result); 
                    window.location.href = "{{url('/admin/edit_doctor')}}/{{$doc_id}}"
