...
function Header() {
    ...
    return <>
        <Head>
            ...
            <script async src={`https://www.googletagmanager.com/gtag/js?id=UA-77811107-2`} defer="defer" data-cfasync="false" />
   ...
   gtag('config', 'UA-77811107-2'); 
      ...
      data-src="https://www.facebook.com/tr?id=499396857525151&ev=PageView&noScript=1" class="lazyload" />` }}
            />
            {/* <!-- // End Pixel Code --> */}
