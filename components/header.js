...
function Header() {
    return <>
        ...
        <Head>
            ...
            <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" type="text/css" as="style" onLoad="this.onload=null;this.rel='stylesheet'" crossOrigin="anonymous" />
...
/* Google tag (gtag.js) */
<script async src="https://www.googletagmanager.com/gtag/js?id=G-VMZ8LSQCJC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-VMZ8LSQCJC');
</script>
            {/* <!-- Global site tag (gtag.js) - Google Analytics --> */}
            <script async src="https://www.googletagmanager.com/gtag/js?id=AW-854769480" defer="defer" data-cfasync="false"></script>
            ...
            {/*<!-- Google tag (gtag.js) -->*/}
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-TQJ6LVC3YT">
            </script>
            <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){`{dataLayer.push(arguments);}`}
            ...
            gtag('config', 'G-TQJ6LVC3YT');
            </script>
            {/*<!-- Google tag (gtag.js) -->*/}
            <script async
                src="https://www.googletagmanager.com/gtag/js?id=AW-11485689248"></script>
                <script>
                window.dataLayer = window.dataLayer || [];
                function gtag(){`{dataLayer.push(arguments);}`}
                gtag('js', new Date());

                gtag('config', 'AW-11485689248');
                </script>
...
}`}(window,document,'script','dataLayer','GTM-P7KNR3BJ');
...
{/*<!-- End Google Tag Manager -->*/}
            ...
            {/* <!-- Facebook Pixel Code --> 02 March 2023 */}
            <script async type="text/javaScript">
                !function (f, b, e, v, n, t, s) {`
            {
                !function(f,b,e,v,n,t,s)
                ...
                s.parentNode.insertBefore(t,s)}`}(window, document, 'Script',
                'https://connect.facebook.net/en_US/fbevents.js');
                fbq('init', '706792496400347');
                fbq('track', 'PageView');
            </script>
            <noScript dangerouslySetInnerHTML={{ __html: `<img height="1" width="1" style="display:none" data-src="https://www.facebook.com/tr?id=706792496400347&ev=PageView&noScript=1" class="lazyload"` }} />
            {/* <!-- End of Facebook Pixel Code --> */}
        ...
        <noScript dangerouslySetInnerHTML={{ __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P7KNR3BJ"
                            ...
                            <nav className="main-nav float-right d-none d-lg-none">
                                <ul>
                                    ...
                                    <li className="drop-down"><Link href="#"><a>About Us</a></Link>
                                        <ul>
                                            <li><Link href="/dr-mrinalini-sharma" onClick={() => setTimeout(() => { setOpen(!open) }, 100)}><a>Dr. Mrinalini Sharma</a></Link></li>
                                            <li><Link href="/plastic-surgeon-in-delhi" onClick={() => setTimeout(() => { setOpen(!open) }, 100)}><a>Plastic Surgeon in Delhi</a></Link></li>
                                ...
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item dropdown"><Link href="#"><a className="nav-link dropdown-toggle" id="one" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About Us</a></Link>
                                        <div className="dropdown-menu" aria-labelledby="one">
                                            <ul>
                                                <li><Link href="/dr-mrinalini-sharma"><a className="dropdown-item">Dr. Mrinalini Sharma</a></Link></li>
                                                <li><Link href="/plastic-surgeon-in-delhi"><a className="dropdown-item">Plastic Surgeon in Delhi</a></Link></li>
